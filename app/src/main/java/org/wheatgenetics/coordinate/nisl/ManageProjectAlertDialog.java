...
class ManageProjectAlertDialog extends org.wheatgenetics.androidlibrary.AlertDialog
{
    ...
    {
        this.setTitle(
            org.wheatgenetics.coordinate.R.string.NavigationItemSelectedListenerManageProjectTitle);
    }
    ...
    {
        {
            @android.support.annotation.StringRes final int items[];
            {
                    ...
                    new java.util.ArrayList<java.lang.Integer>();
                {
                    ...
                    if (this.includedLoadProjectItem) arrayList.add(org.wheatgenetics
                        .coordinate.R.string.NavigationItemSelectedListenerLoadProject);


                    this.includedClearProjectItem = projectModelIsLoaded;
                    if (this.includedClearProjectItem) arrayList.add(org.wheatgenetics
                        .coordinate.R.string.NavigationItemSelectedListenerClearProject);


                    if (projectsExists) arrayList.add(org.wheatgenetics
                        .coordinate.R.string.NavigationItemSelectedListenerDeleteProject);
                }
