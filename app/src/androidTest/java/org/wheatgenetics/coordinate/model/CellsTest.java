...
public class CellsTest extends java.lang.Object
{
    ...
    {
        new org.wheatgenetics.coordinate.model.Cells(3,3).makeRandomCells(
            1,0,3);
    }
    ...
    @org.junit.Test() public void makeRandomCellsFailsAndSucceeds()
    {
        ...
        {
            final int maxRow = 2, maxCol = 2;
            cells = new org.wheatgenetics.coordinate.model.Cells(maxRow, maxCol);
    ...
    @org.junit.Test() public void bigContainsIsFalse()
    {
        org.junit.Assert.assertFalse(new org.wheatgenetics.coordinate.model.Cells(
            5,5).contains(new org.wheatgenetics.coordinate.model.Cell(
                10,10)));
    }
    // endregion
